...
#using binwidth turns this into a useless gray block for some reason
```
...
Write a few sentences about the distribution of danceability scores in the Spotify dataset. Is it a normal distribution, or is it skewed in one direction? What does the mean and one standard distribution tell us about the songs in the dataset? Draft a short story pitch from this data.
  ...
  The data is skewed towards a danceability score of at least over .5 (both 1 sd above and below exceed this value), peaking within one standard deviation above the mean. It can be argued that it is somewhat normal distribution as it has a visible curve, but overall it skews higher.
  A story made from this data could be about the popularity of dance music/danceable music compared to music made for other purposes. Analyzing several years' music data could reveal if it is part of a broader trend.
