...
GDP_data |>
  ...
  labs(title = "Relationship between the United States GDP and DJIA, quarterly")
```
...
Write a few sentences about the relationship between the DJIA and GDP. Is there a strong correlation between the two variables? What does the scatterplot show?
  ...
  There is a strong correlation between the DJIA and GDP seen with the high correlation coefficient. The scatterplot shows that this correlation is very strong when DJIA and GDP are lower, but becomes weaker as they rise.
